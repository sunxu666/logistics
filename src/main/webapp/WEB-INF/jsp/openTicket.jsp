    ...
    <div class="right" id="mainFrame">
        ...
        <div class="right_cont">
            ...
            <div style="width:900px;margin:auto;">
                <form action="/saveTicketNo"  >
                    <table class="table table-bordered">
                        <tr>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">日期：</td>
                            <td width="23%"><input type="text" class="laydate-icon span1-1" id="Calendar"
                                name="createDate"     value="2015-08-25"/></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">直达站：</td>
                            <td width="23%"><input type="text" name="toStand" id="" class="span1-1"/></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">中转至：</td>
                            <td><input type="text" name="transferTo" id="" class="span1-1"/></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">卡号：</td>
                            <td><input type="text" name="cardNumber" id="" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">发货人：</td>
                            <td><input type="text" name="consigner" id="" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">电话：</td>
                            <td><input type="text" name="consignerPhoto" id="" class="span1-1"/></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">票号：</td>
                            <td><input type="text" name="ticketNumber" id="input" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">收货人：</td>
                            <td><input type="text" name="consignee" id="input2" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">电话：</td>
                            <td><input type="text" name="consigneePhoto" id="input3" class="span1-1"/></td>
                        </tr>
                    </table>
                    <table class="table table-bordered">
                        <tr>
                        ...
                        <tr>
                            <td align="center"><input type="text" name="cargoName" id="input4" class=" span2"/></td>
                            <td align="center">

                                <select name="packaging" id="select" class=" span1" >
                                    <option selected="selected" value="0">无</option>
                                    <option value="1" >有</option>
                                </select>
                            </td>
                            <td align="center"><input type="text" name="number" id="input5" class=" span1 text-center"
                                                      value="22"/></td>
                            <td align="center"><input type="text" name="freight" id="input6" class=" span1 text-center"
                                                      value="22"/></td>
                            <td align="center"><input type="text" name="weight1" id="input7" class=" span1 text-center"
                                                      value="22"/></td>
                            <td align="center"><input type="text" name="volume" id="input8" class=" span1 text-center"
                                                      value="22"/></td>
                            <td align="center">
                                <select name="clearingForm" id="selectPayment " class=" span1">
                                    <option selected="selected" value="1">立即付款</option>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td width="23%"><input type="text" name="" id="input10" class="span1-1"/></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">中转费：</td>
                            <td width="23%"><input type="text" name="" id="input14" class="span1-1"/></td>
                            <td width="10%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">保险金额：</td>
                            <td><input type="text" name="" id="input15" class="span1-1"/></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">保费：</td>
                            <td><input type="text" name="" id="input1-1" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">送货费：</td>
                            <td><input type="text" name="" id="input12" class="span1-1"/></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">送货方式：</td>
                            <td><input type="text" name="" id="input16" class="span1-1"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="" id="input13" class="span1-1"/></td>
                        ...
                        <tr>
                            ...
                            <td nowrap="nowrap"><select name="" id="select2" class=" span1-1">
                                <option>郑州</option>
                            </select>
                                <input type="text" name="" id="input13" class="span1"/>
                                <select name="" id="select2" class=" span1">
                                    <option>无</option>
                                </select></td>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">标签数量：</td>
                            <td colspan="3"><input type="text" name="" id="input17" class="span1"/>
                        ...
                        <tr>
                            ...
                            <td colspan="5" nowrap="nowrap"><input type="text" name="" id="input9"
                                                                   class="span10"/></td>
                        </tr>
                    </table>
